...
To start with, I counted the ratings of players in my data set. I created bins of 200 rating points, starting from 600 (the minimum possible rating on Lichess).
