...
Additionally, we recorded the silhouette score for each number of clusters to validate our choice. Table \ref{table:silhouetteScoresForBaseOpeningsClusteredByGameResults} shows the silhouette score for each number of clusters from three to ten -- it confirms that the optimal number of clusters is four, with the best silhouette score of 0.478.

\begin{table}[H]
    \centering
    \caption{Silhouette Scores for K-Means Clustering of Base Openings by Game Results}
    \label{table:silhouetteScoresForBaseOpeningsClusteredByGameResults}
    \begin{tabular}{| l | l |} 
        \hline
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.55\textwidth]{Effect of Higher Rating on White Win Rate.png}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=\textwidth]{Mean White Win Rate for Each EloDiff Bin.png}
\end{figure}
