...
We sought to predict the result of a game using both decision tree classifiers and random forests with various features. Figure \ref{fig:resultsOfModelsToPredictResultOfAGame} shows highlights of the results we obtained from our models.
...
\begin{figure}
    ...
    \begin{tabular}{| c | c | c | c |} 
        ...
        \hline
        Random Forest & BaseOpening, RelativeEloDiffBin (5\% Increments) & 0.??? & 0.??? \\ 
        \hline
