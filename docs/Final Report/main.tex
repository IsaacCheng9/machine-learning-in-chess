...
\begin{figure}[H]
    ...
    \includegraphics[width=0.6\textwidth]{Base Openings Clustered by Game Results (White Win Rate vs Black Win Rate).png}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.6\textwidth]{Base Openings Clustered by Game Results (White Win Rate vs Draw Rate).png}
\end{figure}
