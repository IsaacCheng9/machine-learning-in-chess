...
\begin{figure}[H]
    \centering
    \caption{Elbow Method for K-Means Clustering of Base Openings by Average Difference of Results in Variations}
...
\begin{figure}[H]
    \centering
    \caption{Silhouette Scores for K-Means Clustering of Base Openings by Average Difference of Results in Variations}
...
\begin{figure}[H]
    \centering
    \caption{Base Openings Clustered by Difference of Results in Variations}
