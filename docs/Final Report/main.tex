...
\subsection{Regression Analysis of Base Opening Popularity}
\begin{figure}[H]
    \centering
    \caption{Popularity of Base Opening vs. White Win Rate (All Rated Players)}
    \label{fig:popularityOfBaseOpeningVsWhiteWinRateAllPlayers}
    \includegraphics[width=0.6\textwidth]{Popularity of Base Opening vs. White Win Rate (All Rated Players).png}
\end{figure}

\begin{figure}[H]
    \centering
    \caption{Popularity of Base Opening vs. Black Win Rate (All Rated Players)}
    \label{fig:popularityOfBaseOpeningVsBlackWinRateAllPlayers}
    \includegraphics[width=0.6\textwidth]{Popularity of Base Opening vs. Black Win Rate (All Rated Players).png}
\end{figure}
