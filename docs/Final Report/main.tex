...
\newpage
\begin{abstract}
Chess is a popular strategy game that has grown tremendously over the past decade. As the popularity of chess has developed, large-scale exploration of chess games has become more feasible. In this paper, we explore data mining and machine-learning techniques on millions of online-rated chess games in 2022 to discover patterns and insights into how people play chess.
