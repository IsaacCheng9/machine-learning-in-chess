...
Since the first digital computer was switched on 1945, programmers have sought to build a machine that could defeat the world chess champion \cite{earlyComputerChessHistory}. Bell Laboratories wrote a paper in 1949 that described a computer that could play chess \cite{shannon1950xxii}. However, the computer was not able to beat the world champion at the time, Emanuel Lasker.
