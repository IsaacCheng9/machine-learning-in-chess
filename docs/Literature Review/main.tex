...
In chess, the value of a piece is determined by its ability to influence the outcome of the game. Valuation systems typically assign one point to a pawn, three points to a knight, three points to a bishop, five points to a rook, and nine points to a queen.
