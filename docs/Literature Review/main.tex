...
This saga demonstrates the practical use of chess databases, as the patterns that we find from our analyses can be used to identify players who are cheating. While we will not be creating the cheat detection algortihms themselves, the patterns that we find could be used to create or improve such algorithms. We could cluster players by their playstyle using metrics such as tendency to sacrifice pieces, and then these clusters could be used to flag players who are playing abnormally. Similarly, we could analyse games to determine the parameter space of chess players on x and y-axes, and this could identify players who demonstrate abilities beyond the wider chess population and flag them for further investigation.
